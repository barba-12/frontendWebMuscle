...
<div className="p-4 w-full">
      ...
      <select value={metrica} onChange={(e) => setMetrica(e.target.value)} className="select-viola" style={{marginRight:"10px", textAlign:"center"}}>
        <option value="rep">Ripetizioni</option>
        <option value="carico">Carico</option>
        <option value="recupero">Tempo di Recupero</option>
      </select>

      <select value={numRel} onChange={(e) => setNumRel(e.target.value)} className="select-viola" style={{textAlign:"center"}}>
